...
namespace CRUD.Series
{
    class Program
    {
        ...
        private static void ListarSeries()
        {
            ...
            foreach (var serie in lista)
            {
                ...
                if(excluido == false)
                {
                    ...
                    System.Console.WriteLine("Ano: {0}: - Gênero: {1}", serie.retornaAno(), serie.retornaGenero());
                    System.Console.WriteLine($"Descrição:  {serie.retornaDescricao()}");
        ...
        {
            System.Console.WriteLine();
            System.Console.WriteLine("Séries para você!");
